...
AWS（Amazon Web Services）是一个提供多种云计算服务的平台，它不仅限于IaaS（Infrastructure as a Service，基础设施即服务）。AWS实际上提供了IaaS、PaaS（Platform as a Service，平台即服务）、和 SaaS（Software as a Service，软件即服务）三种类型的服务。
...
所以说，AWS 是一个综合性的云服务提供商，它提供从底层基础设施到上层应用软件的全方位服务。不同的AWS服务可能属于这个分类中的不同层级
